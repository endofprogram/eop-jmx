 ...
 * @since 2017-06-02
 */
class MapConverterTest03 extends AbstractCommonTest {
...
<e>e</e>
		...
		Assert.assertEquals('<a><b><d1><d1d>d</d1d><d1e>e</d1e></d1><e1><e1d>d</e1d><e1e>e</e1e></e1></b><c><d><d>d</d><e>e</e></d><e><d>d</d><e>e</e></e></c></a>', MapConverter.toXml(org.eop.jmx.parser.JsonParser.parseNetsfJson(json), cs))
	}
...
<b>b</b>
		...
		Assert.assertEquals('<a><b>b</b><b>b</b></a>', MapConverter.toXml(org.eop.jmx.parser.JsonParser.parseNetsfJson(json), cs))
	}
...
<g>g</g>
		...
		Assert.assertEquals('<a><b>b</b><c>c</c><d><e><f>f</f><g>g</g></e><e><f>f</f><g>g</g></e></d></a>', MapConverter.toXml(org.eop.jmx.parser.JsonParser.parseNetsfJson(json), cs))
	}
...
<g>g</g>
		...
		Assert.assertEquals('<a><b>b</b><c>c</c><d><b>b</b><c>c</c><e><f>f</f><g>g</g></e><e><f>f</f><g>g</g></e></d><h><b>b</b><c>c</c><e><f>f</f><g>g</g></e><e><f>f</f><g>g</g></e></h></a>', MapConverter.toXml(org.eop.jmx.parser.JsonParser.parseNetsfJson(json), cs))
	}
...
<g>g</g>
		...
		Assert.assertEquals('<a><b>b</b><c>c</c><x>x</x><x>x</x><d><b>b</b><c>c</c><xs><x>x</x><x>x</x></xs><es><e><f>f</f><g>g</g></e><e><f>f</f><g>g</g></e></es></d><h><b>b</b><c>c</c><x>x</x><x>x</x><es><e><f>f</f><g>g</g></e><e><f>f</f><g>g</g></e></es></h></a>', MapConverter.toXml(org.eop.jmx.parser.JsonParser.parseNetsfJson(json), cs))
	}
}
